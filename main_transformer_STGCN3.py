'''
    一部分将整个视频帧[334, 1024]输入transformer中，另一部分输入STGCN
    一种方法是相加，另一种方法是连接，需要更改部分代码,相加且为128的效果不好
'''
...
from models.Transf_STGCN3 import Transf_STGCN3
args = Get_args()
...
class Object():
    def __init__(self, args, model=None, k=None):
        ...
        if model == None:
            ...
            self.model = Transf_STGCN3(num_features=args.inchannel, args=args).to(self.device)
